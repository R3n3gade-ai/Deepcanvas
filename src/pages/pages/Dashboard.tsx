          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex space-x-2">
              <SaveToBrainButton
                ...
                pageContent={`Dashboard summary: ${openDealsCount} open deals, ${formatCurrency(totalPipelineValue)} pipeline value, ${taskCount} pending tasks.`}
                variant="outline"
              />
              <button
                ...
                onClick={() => {
                  ...
                  const dashboardContent = `
                    ...
                    ${dealStageData.map(stage => `${stage.name}: ${stage.count} deals (${formatCurrency(stage.value)})`).join('\n')}
                  `;

                  enableCapture('Dashboard Snapshot', dashboardContent);
                }}
              >
                <span className="mr-1">Capture Dashboard</span>
